...
const initJs = function () {
   ...
   */
  const mobileMenuButton = select('#btn-mobile-menu')
  const mobileMenu = select('.mobile-menu')
  if (mobileMenuButton) {
    on('click', '#btn-mobile-menu', () => {
      mobileMenuButton.classList.toggle('d-none')
      if (mobileMenu) {
  ...
  if (portfolioContainer) {
    ...
    const portfolioFilters = select('#portfolio-filters li a', true)
    on(
      'click',
